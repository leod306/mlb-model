...
def main() -> None:
    ...
    # Isotonic calibrator disabled — it maps most inputs to the same plateau value,
    # producing identical win probabilities across games. Raw ensemble probabilities
    # are already distinct per game and more useful.
